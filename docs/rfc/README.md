...
|----|-------|--------|------|--------|------|
| RFC-0001 | Deslopinator: Go-native codebase health with anti-gaming scoring | Draft | 2026-05-07 | Donald Gifford | [0001-deslopinator-go-native-codebase-health-with-anti-gaming-scoring.md](0001-deslopinator-go-native-codebase-health-with-anti-gaming-scoring.md) |
